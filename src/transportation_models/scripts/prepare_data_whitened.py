...
This version uses "whitened" timeseries, meaning that the timeseries data has been preprocessed by:
    1) Subtracting the mean
    2) Dividing by the standard deviation
Note that mean and standard deviation here are calculated for each time window (i.e., 5pm on Monday
has a different mean and variance than 5:05pm on Monday)

Otherwise, this script reproduces prepare_data.py
"""
...
#%% #####     Data Loading     #####
detectors = retrieve_detectors(detector_type='Mainline')
