...
``src/ctm_for_dwc/utils/ctm/ctmsim_configs/`` (24-hour macroscopic
freeway snapshots from CTMSIM v1.1, see :mod:`ctm_for_dwc.utils.ctm.io`),
...
CONFIGS = REPO / "src/ctm_for_dwc/utils/ctm/ctmsim_configs"
RESULTS = REPO / "src/ctm_for_dwc/utils/ctm/ctmsim_results"
