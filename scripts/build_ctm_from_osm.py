...
:mod:`ctm_for_dwc.utils.ctm.osm`, lays out cells with
:func:`ctm_for_dwc.utils.ctm.cells.cells_from_corridor`, and writes:
...
Run from the repo root::
    ...
    # `ctm_for_dwc.utils.ctm.caltrans` for the source):
    python scripts/build_ctm_from_osm.py \\
        --graphml tests/fixtures/osm/i210_bbox.graphml \\
        --ref "I 210" --direction W \\
...
from ctm_for_dwc.utils.ctm.osm import Corridor, corridor_from_graph
